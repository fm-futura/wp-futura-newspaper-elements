...
class td_block_futura_grid_flex_4 extends td_block_big_grid_flex_4 {
    ...
    function inner($posts, $td_column_number = '') {
        ...
        if (!empty($posts)) {
            ...
            foreach ( $posts as $post ) {
                if ($post_count == 0) {
                    $td_module_flex = new td_module_futura_flex_6($post, $this->get_all_atts());
                ...
                $td_module_flex_2 = new td_module_futura_flex_7($post, $this->get_all_atts());
    ...
    function get_block_classes($additional_classes_array = array() ) {
        return parent::get_block_classes($additional_classes_array) . ' td_block_big_grid_flex_4';
    }
